function showSidebar() {
    ...
    sidebar.classList.add('show-sidebar'); // Agrega la clase para mostrar la barra lateral
}

function hideSidebar() {
    const sidebar = document.querySelector('.sidebar');
    sidebar.classList.remove('show-sidebar'); // Elimina la clase para ocultar la barra lateral
}

// Función para agregar contenido al hacer clic en el botón
function agregarContenido() {
  ...
  function agregarContenido() {
    ...
    document.getElementById('boton3').addEventListener('click', agregarContenido);
    
    // Función para agregar contenido al hacer clic en el botón 4
// Función para agregar contenido al hacer clic en el botón 4
  ...
  const contenidoBoton4 = `
    <div class="container">
      <div class="button-container">
        <div class="info">
          <div class="text">
            <h2>Herramientas y Tecnologías en Diseño Gráfico</h2>
...
document.getElementById('boton4').addEventListener('click', agregarContenidoBoton4);
  ...
  // Agregar evento de clic al botón
  document.getElementById('boton2').addEventListener('click', agregarContenido);
